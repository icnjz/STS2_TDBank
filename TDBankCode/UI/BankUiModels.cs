...
public sealed record BankUiSnapshot
{
    ...
    public int SavingsInterestRateBasisPoints { get; init; } = 150;

    public int SavingsInterestCap { get; init; } = 10;

    public IReadOnlyList<BankCreditOffer> CreditOffers { get; init; } =
   new BankCreditOffer[]
   {
            new(BankCreditTier.Starter, 150, 200, 400, 2_199),
            new(BankCreditTier.MiddleClass, 600, 700, 1_400, 2_499),
            new(BankCreditTier.NouveauRiche, 1_600, 1_200, 2_400, 2_799),
   };
